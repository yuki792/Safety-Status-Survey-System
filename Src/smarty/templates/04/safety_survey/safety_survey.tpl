...
<title>安否確認 | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<p>右側のサイドメニューから利用したいサービスを選択してください。</p>
...
<ul class="sidemenu">
<li><a href="index.php?func=send_survey">安否確認メール新規送信</a></li><!-- リンク先とサイドメニュータイトルを入力 -->
<li><a href="index.php?func=resend_survey">安否確認メール再送信</a></li>
<li><a href="index.php?func=cross_finder">伝言板 Cross Finder</a></li>
<li><a href="index.php?func=twitter_observe">Twitterつぶやき監視</a></li>
