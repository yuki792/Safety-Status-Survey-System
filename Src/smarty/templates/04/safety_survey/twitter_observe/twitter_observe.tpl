...
<title>Twitterつぶやき監視 | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<p>
Twitterのつぶやきから安否の確認を行います。<br />
※人数が多い場合、検索に時間がかかる場合があります。
</p>
...
<div class="form">
<p>
<form action='index.php?func=twitter_observe' method="post">
