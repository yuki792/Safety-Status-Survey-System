...
<th>検索件数</th>
<td>
{$quantity|default:""}&nbsp件<br />
</td>
</tr>

<tr>
<th>予想検索時間</th>
<td>{$time|default:""}&nbsp秒</td>
</tr>
...
<input type="hidden" name="title" value="{$survey_id|default:""}">
<input type="submit" name="send_button" value="検索開始">
