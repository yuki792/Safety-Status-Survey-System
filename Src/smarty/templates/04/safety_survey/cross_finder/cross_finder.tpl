...
<title>伝言板 Cross Finder | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<li><span>伝言板 Cross Finder</span></li>
</ul>
<!-- ↑パンくずリンクここまで↑ -->
...
<h2>伝言板 Cross Finder</h2>

<p>
※この機能は携帯電話会社の災害用伝言板サービスが提供されている期間のみ利用出来ます。<br />
※1件の検索に対して最低3秒の時間がかかります。大量検索する場合はご注意ください。
</p>

<p>
伝言板検索を行う安否確認のタイトルを選択してください。
</p>
...
<div class="form">
<p>
<form action='index.php?func=cross_finder' method="post">
...
<td colspan="2">
<div align="center">
<input type="submit" name="confirm_button" value="&nbsp&nbsp&nbsp次へ&nbsp&nbsp&nbsp">
</div>
</td>
</tr>
