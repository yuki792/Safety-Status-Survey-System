...
<tr>
<th>学部</th>
<td>{$faculty_name|default:""}</td>
</tr>

<tr>
<th>学科</th>
<td>{$course_name|default:""}</td>
</tr>
...
<input type="hidden" name="member_id" value="{$member_id|default:""}">
<input type="hidden" name="last_name" value="{$last_name|default:""}">
<input type="hidden" name="first_name" value="{$first_name|default:""}">
<input type="hidden" name="faculty_id" value="{$faculty_id|default:""}">
<input type="hidden" name="faculty_name" value="{$faculty_name|default:""}">
...
<input type="hidden" name="group_password" value="{$group_password|default:""}">
