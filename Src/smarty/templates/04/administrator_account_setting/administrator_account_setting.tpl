...
<tr>
<th><label for="mail">メールアドレス&nbsp<span class="require">*</span></label></th>
<td><input type="text" id="mail" name="mail" value="{$mail|default:""}" size="30" /></td>
</tr>

<tr>
<th><label for="mail_confirm">メールアドレス（確認）&nbsp<span class="require">*</span></label></th>
<td><input type="text" id="mail_confirm" name="mail_confirm" value="{$mail_confirm|default:""}" size="30" /></td>
</tr>
