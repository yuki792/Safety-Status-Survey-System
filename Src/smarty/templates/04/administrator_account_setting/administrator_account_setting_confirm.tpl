...
<td colspan="2">
<div align="center">
<form action='index.php?func=administrator_account_setting' method="post">
<input type="hidden" name="mail" value="{$mail|default:""}">
<input type="hidden" name="mail_confirm" value="{$mail_confirm|default:""}">
