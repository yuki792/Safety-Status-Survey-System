...
<title>管理者ページ | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<ul class="sidemenu">
<li><a href="index.php?func=administrator_account_setting">登録情報変更</a></li><!-- リンク先とサイドメニュータイトルを入力 -->
<li><a href="index.php?func=member_signup">新規利用者登録</a></li> 
<li><a href="index.php?func=member_delete">利用者アカウント削除</a></li>
<li><a href="index.php?func=safety_survey">安否確認</a></li>
<li><a href="index.php?func=survey_result">安否確認状況閲覧</a></li>
<li class="last"><a href="index.php?func=administrator_logout">ログアウト</a></li> <!-- リンク先とサイドメニュータイトルを入力（サイドメニューのラストはclass指定を忘れずに -->
</ul>
</div>
