...
<title>管理者ログイン | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<div align="center">
<p>
<form action="index.php?func=administrator_login" method="post">
...
<tr>
<th align="right">
<label for="administrator_id">管理者ID：</label></th>
<td>
<input type="text" id="administrator_id" name="administrator_id" value="" size="20"></td>
</tr>
<tr>
<th align="right">
