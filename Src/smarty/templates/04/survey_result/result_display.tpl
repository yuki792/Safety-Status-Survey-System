...
<title>安否確認状況閲覧 | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<link rel="stylesheet" href="./commons/default.css" type="text/css" />
<link rel="stylesheet" href="./commons/contents.css" type="text/css" />
...
<p><div class="h3_wrapper"><h3>{$title|default:""}&nbspの安否確認状況</h3></div></p>
<div align="center">
{$pie_chart|default:""}
<br /><br /><br />
{$bar_chart|default:""}
...
{if $error_message eq ''}
<div class="main">
<p><div class="h3_wrapper"><h3>{$title|default:""}&nbspの安否情報一覧</h3></div></p>
<table class="sample7">
<thead>
<tr>
<th class="id">利用者ID</th>
<th class="name">名前</th>
<th class="anpi">安否状態</th>
<th class="detail">詳細情報</th>
</tr>
</thead>
<tbody>
{$result|default:""}
...
<ul class="sidemenu">
<li class="last"><a href="index.php?func=administrator_page">管理者ページに戻る</a></li> <!-- リンク先とサイドメニュータイトルを入力（サイドメニューのラストはclass指定を忘れずに -->
</ul>
</div>
