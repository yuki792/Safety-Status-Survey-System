...
<title>登録内容確認 | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<tr>
<th>名前</th>
<td>{$last_name|default:""}&nbsp{$first_name|default:""}</td>
</tr>
...
<tr>
<th>携帯メールアドレス</th>
<td>{$phone_mail|default:""}</td>
</tr>

<tr>
<th>携帯電話番号</th>
<td>{$phone_number|default:""}</td>
</tr>

<tr>
<th>その他メールアドレス１</th>
<td>{$other_mail1|default:""}</td>
</tr>

<tr>
<th>その他メールアドレス２</th>
<td>{$other_mail2|default:""}</td>
</tr>

<tr>
<th>その他メールアドレス３</th>
<td>{$other_mail3|default:""}</td>
</tr>

<tr>
<th>fリンクメールアドレス１</th>
<td>{$flink_mail1|default:""}</td>
</tr>

<tr>
<th>fリンクメールアドレス２</th>
<td>{$flink_mail2|default:""}</td>
</tr>

<tr>
<th>fリンクメールアドレス３</th>
<td>{$flink_mail3|default:""}</td>
</tr>

<tr>
<th>fリンクメールアドレス４</th>
<td>{$flink_mail4|default:""}</td>
</tr>

<tr>
<th>fリンクメールアドレス５</th>
<td>{$flink_mail5|default:""}</td>
</tr>

<tr>
<th>twitter ID</th>
<td>{$twitter_id|default:""}</td>
</tr>
...
<input type="hidden" name="last_name" value="{$last_name|default:""}">
<input type="hidden" name="first_name" value="{$first_name|default:""}">
<input type="hidden" name="password" value="{$password|default:""}">
<input type="hidden" name="password_confirm" value="{$password_confirm|default:""}">
<input type="hidden" name="phone_mail" value="{$phone_mail|default:""}">
<input type="hidden" name="phone_mail_confirm" value="{$phone_mail_confirm|default:""}">
<input type="hidden" name="phone_number" value="{$phone_number|default:""}">
<input type="hidden" name="other_mail1" value="{$other_mail1|default:""}">
<input type="hidden" name="other_mail2" value="{$other_mail2|default:""}">
<input type="hidden" name="other_mail3" value="{$other_mail3|default:""}">
<input type="hidden" name="flink_mail1" value="{$flink_mail1|default:""}">
<input type="hidden" name="flink_mail2" value="{$flink_mail2|default:""}">
<input type="hidden" name="flink_mail3" value="{$flink_mail3|default:""}">
<input type="hidden" name="flink_mail4" value="{$flink_mail4|default:""}">
<input type="hidden" name="flink_mail5" value="{$flink_mail5|default:""}">
<input type="hidden" name="twitter_id" value="{$twitter_id|default:""}">
