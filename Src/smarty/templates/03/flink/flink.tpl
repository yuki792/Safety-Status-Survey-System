...
<title>fリンク | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<div id="mainImage2">
<img src="images/title_flink.jpg" alt="イメージ画像" width="880" height="120" /> <!-- イメージ画像を指定 -->
</div>
</div>
...
<div class="form">
<p>
<form action="index.php?func=flink" method="post">
...
<td>
<input type="text" id="mail_addr" name="mail_addr" value="{$mail_addr|default:""}" size="30" />
</td>
</tr>

<tr>
<th><label for="mail_addr_confirm">メールアドレス（確認）&nbsp<span class="require">*</span></label></th>
<td>
<input type="text" id="mail_addr_cofirm" name="mail_addr_confirm" value="{$mail_addr_confirm|default:""}" size="30" />
</td>
</tr>
...
<td colspan="2">
<div align="center">
<input type="hidden" name="fmail" value="{$fmail|default:""}">
