...
<title>利用者ページ | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<ul class="sidemenu">
<li><a href="index.php?func=account_setting_start">登録情報変更</a></li> <!-- リンク先とサイドメニュータイトルを入力 -->
<li><a href="index.php?func=reply_survey_select">安否回答</a></li>
<li class="last"><a href="index.php?func=member_logout">ログアウト</a></li> <!-- リンク先とサイドメニュータイトルを入力（サイドメニューのラストはclass指定を忘れずに -->
</ul>
</div>
