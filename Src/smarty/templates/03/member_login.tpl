...
<title>利用者ログイン | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<li><span>{#navi03_jname#}</span></li> <!-- パンくずを入力（アクティヴはspan要素で） -->
</ul>
<!-- ↑パンくずリンクここまで↑ -->
...
<div align="center">
<p>
<form action="index.php?func=member_login" method="post">
<fieldset style="width:400px;">
<legend>ログインフォーム</legend>
<span class="error">{$error_message|default:""}</span>
<br />
<table border="0">
<tr>
<th align="right">
<label for="member_id">利用者ID：</label></th>
<td>
<input type="text" id="member_id" name="member_id" value="" size="20"></td>
</tr>
<tr>
<th align="right">
<label for="password">パスワード：</label></th>
<td>
<input type="password" id="password" name="password" value="" size="20"></td>
</tr>
</table>
<br />
