...
<title>{#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<div id="navigator">
<ul>
<li class="active"><a href={#http_host#}{#navi00_url#}>{#navi00_jname#} <span>{#navi00_ename#}</span></a></li> <!-- リンク先とメニュータイトル（日本語と英語）を入力 -->
...
<div id="mainImage">
<p>災害発生時の安否確認システムです。</p> <!-- コンテンツ内容の概要を入力（表示はされません） -->
</div>
</div>
...
<p>
<strong>
「4S - 安否確認システム - 」 は、地震などの災害が発生した時に利用者（学生）へ安否確認メールを一斉送信し、
さらに安否の回答・集計・確認が行えるシステムです。
</strong>
</p>
