...
<title>{#navi02_jname#} | {#site_name#}</title> <!-- タイトルを入力（SEO対策で重要） -->
...
<li class="active"><a href={#http_host#}{#navi02_url#}>{#navi02_jname#} <span>{#navi02_ename#}</span></a></li> <!-- リンク先とメニュータイトル（日本語と英語）を入力 -->
...
<div id="mainImage2">
<img src="images/title02.jpg" alt="イメージ画像" width="880" height="120" /> <!-- イメージ画像を指定 -->
</div>
</div>
...
<li><span>{#navi02_jname#}</span></li> <!-- パンくずを入力（アクティヴはspan要素で） -->
</ul>
<!-- ↑パンくずリンクここまで↑ -->
...
<!-- コンテンツここから -->
<h2>使い方</h2>
<div class="h3_wrapper"><h3>利用開始の流れ</h3></div>
<div class="hp_section">
<ol>
<li> 1.管理者による新規アカウント作成</li>
<li> 2.アカウント作成完了メール送信</li>
<li> 3.仮パスワードによるログイン</li>
<li> 4.アカウント情報の設定</li>
<li> 5.利用開始</li>
</ol>
</div>

<div class="h3_wrapper"><h3>安否確認の流れ</h3></div>
<div class="hp_section">
<ol>
<li> 1.管理者による安否確認メール送信</li>
<li> 2.メール本文中のURLをクリック</li>
<li> 3.安否情報を入力</li>
<li> 4.安否登録完了</li>
</ol>
</div>
